...
public class TestProcessor {
    ...
    public void testSimple() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "\n"
                + "public final class TestSimple$$StateSaver<T extends TestSimple> extends Injector.Object<T> {\n"
    ...
    public void testProperty() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestProperty$$StateSaver<T extends TestProperty> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
    ...
    public void testNested() {
        ...
        JavaFileObject expected1 = JavaFileObjects.forSourceString(getName("TestNested$Inner1$InnerInner1", true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestNested$Inner1$InnerInner1$$StateSaver<T extends TestNested.Inner1.InnerInner1> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
        ...
        JavaFileObject expected2 = JavaFileObjects.forSourceString(getName("TestNested$Inner2$InnerInner1", true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestNested$Inner2$InnerInner1$$StateSaver<T extends TestNested.Inner2.InnerInner1> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
    ...
    public void testView() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestView$$StateSaver<T extends TestView> extends Injector.View<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
    ...
    public void testBundler() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestBundler$$StateSaver<T extends TestBundler> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
    ...
    public void testAllTypes() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestTypes$$StateSaver<T extends TestTypes> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
    ...
    public void testReflection() {
        ...
        JavaFileObject expected = JavaFileObjects.forSourceString(getName(className, true), ""
                ...
                + "import java.util.HashMap;\n"
                + "\n"
                + "public final class TestTypesReflection$$StateSaver<T extends TestTypesReflection> extends Injector.Object<T> {\n"
                + "  private static final HashMap<String, Bundler<?>> BUNDLERS = new HashMap<String, Bundler<?>>();\n"
                + "\n"
                ...
                + "        field.setAccessible(true);\n"
                + "      }\n"
                + "      HELPER.putSerializable(state, \"mParcelableArrayList\", "
                + "(java.util.ArrayList<? extends com.evernote.android.state.test.TestTypes.ParcelableImpl>) field.get(target));\n"
                + "      if (!accessible) {\n"
                + "        field.setAccessible(false);\n"
                + "      }\n"
                + "    } catch (Exception e) {\n"
